...
LIBS = $(LIBS_PATH)CCA_S_Enc.o $(LIBS_PATH)CCA_Hash.o $(LIBS_PATH)CCA_Keygen.o $(LIBS_PATH)CCA_RNG.o $(LIBS_PATH)CCA_Board.o $(LIBS_PATH)CCA_B.o $(LIBS_PATH)CCA_B_Dec.o $(LIBS_PATH)CCA_B_Enc.o $(LIBS_PATH)CCA_Wiper.o $(LIBS_PATH)BitBoardOSink.o $(LIBS_PATH)BitBoardFileReader.o
...
$(T_EXEC_PATH)Test_S_Enc.run:    $(LIBS_PATH)CCA_Board.o $(LIBS_PATH)CCA_Keygen.o $(LIBS_PATH)BitBoardOSink.o $(LIBS_PATH)CCA_S_Enc.o $(LIBS_PATH)BitBoardFileReader.o
$(T_EXEC_PATH)Test_Speed.run:  $(LIBS_PATH)CCA_Board.o $(LIBS_PATH)CCA_RNG.o $(LIBS_PATH)CCA_Hash.o $(LIBS_PATH)CCA_Keygen.o $(LIBS_PATH)CCA_B.o $(LIBS_PATH)CCA_B_Enc.o $(LIBS_PATH)CCA_B_Dec.o $(LIBS_PATH)CCA_S_Enc.o $(LIBS_PATH)BitBoardOSink.o $(LIBS_PATH)BitBoardFileReader.o
$(T_EXEC_PATH)Test_B_Enc.run:  $(LIBS_PATH)CCA_Board.o $(LIBS_PATH)CCA_Hash.o $(LIBS_PATH)CCA_B.o $(LIBS_PATH)CCA_B_Enc.o $(LIBS_PATH)CCA_B_Dec.o $(LIBS_PATH)BitBoardOSink.o $(LIBS_PATH)BitBoardFileReader.o $(LIBS_PATH)CCA_Keygen.o
